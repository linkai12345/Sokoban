...
public class Gameing_three {

    private Bitmap blue_brick,brick,red_box,person,box,food,three;
    ...
    public Gameing_three(Bitmap box,Bitmap blue_brick,Bitmap brick,Bitmap red_box,Bitmap person,Bitmap food,Bitmap three){
    ...
    public void draw(Canvas canvas, Paint paint) {
        canvas.drawBitmap(three,0,0,paint);
        int a=0;
    ...
    public void onKeyDown(int keyCode, KeyEvent event) {
        if ((mx==3&&(my==4||my==5))||(mx==4&&(my==3||my==4||my==5)))
            map[mx][my]=6;
        else
            map[mx][my]=9;
